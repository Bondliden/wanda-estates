...
export const AUDIT_DATA: AuditData = {
  title: "Strategic Marketing Audit 2026: Wanda Estates",
  description: "A precision diagnostic of current capabilities versus 2026 luxury market benchmarks.",
  items: [
    {
      id: "1",
      ...
      impact2026: "Aumentar la percepción de valor y la conexión emocional con el comprador ultra-high-net-worth."
    },
    {
      id: "2",
      ...
      impact2026: "Navegación fluida e intuitiva que retiene al usuario y guía hacia la conversión."
    },
    {
      id: "3",
      ...
      impact2026: "Capturar tráfico cualificado buscando zonas exclusivas específicas."
    },
    {
      id: "4",
      ...
      strategicAction: "Implementar formularios simplificados (Nombre/Email) y ofrecer 'Guía de Inversión Marbella 2026' como Lead Magnet.",
      impact2026: "Incrementar drásticamente la conversión de visitantes a leads cualificados."
    },
    {
      id: "5",
      ...
      impact2026: "Diferenciación tecnológica que posiciona a Wanda Estates como líder innovador."
    }
  ]
};