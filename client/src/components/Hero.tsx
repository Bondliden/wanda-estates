  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto h-full flex items-center justify-center px-4">
        <div
          className="max-w-xl text-center text-white transition-transform duration-300 ease-out"
          style={parallaxStyle}
        >
          {/* Main Headline */}
          <h1
          ...
          >
            Más que una propiedad, un legado frente al Mediterráneo: Donde el
            lujo y la calma se encuentran.
          </h1>
          ...
          {/* Body Text */}
          <div className="max-w-3xl mx-auto" style={getParallaxTransform(0.25)}>
            <p className="text-sm md:text-base text-gray-300 leading-relaxed font-light">
              Despertar con vistas panorámicas al Mediterráneo, en espacios
              donde la luz natural define la arquitectura. Nuestra selección
              curada no ofrece solo metros cuadrados, sino un refugio de
              serenidad diseñado para elevar su calidad de vida y asegurar su
              legado patrimonial.
            </p>
          </div>
          ...
          >
            <div className="w-6 h-10 border-2 border-white/50 rounded-full flex justify-center pt-2">
              <div
                className={`w-1 h-3 bg-[#C9A961] rounded-full ${prefersReducedMotion ? "" : "animate-pulse"}`}
              />
            </div>
          </div>
        </div>
